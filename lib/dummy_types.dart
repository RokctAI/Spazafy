...
class KitchenModel {
  KitchenModel([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class TableResponse {
  TableResponse([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory TableResponse.fromJson(Map<String, dynamic> json) => TableResponse();
  Map<String, dynamic> toJson() => {};
}

class ShopTag {
  ShopTag([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory ShopTag.fromJson(Map<String, dynamic> json) => ShopTag();
  Map<String, dynamic> toJson() => {};
}
...
class Series {
  Series([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class SignUpType {
  SignUpType([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory SignUpType.fromJson(Map<String, dynamic> json) => SignUpType();
  Map<String, dynamic> toJson() => {};
}

class Translation {
  Translation([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class ProductStatus {
  ProductStatus([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class AddressData {
  AddressData([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class BonusModel {
  BonusModel([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory BonusModel.fromJson(Map<String, dynamic> json) => BonusModel();
  Map<String, dynamic> toJson() => {};
}

class OrdinalSales {
  OrdinalSales([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory OrdinalSales.fromJson(Map<String, dynamic> json) => OrdinalSales();
  Map<String, dynamic> toJson() => {};
}
...
class HttpService {
  HttpService([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory HttpService.fromJson(Map<String, dynamic> json) => HttpService();
  Map<String, dynamic> toJson() => {};
}

class UnitData {
  UnitData([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory UnitData.fromJson(Map<String, dynamic> json) => UnitData();
  Map<String, dynamic> toJson() => {};
}

class TableModel {
  TableModel([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class LanguageData {
  LanguageData([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory LanguageData.fromJson(Map<String, dynamic> json) => LanguageData();
  Map<String, dynamic> toJson() => {};
}

class Stock {
  Stock([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory Stock.fromJson(Map<String, dynamic> json) => Stock();
  Map<String, dynamic> toJson() => {};
}

class Chart {
  Chart([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory Chart.fromJson(Map<String, dynamic> json) => Chart();
  Map<String, dynamic> toJson() => {};
}

class UserData {
  UserData([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory UserData.fromJson(Map<String, dynamic> json) => UserData();
  Map<String, dynamic> toJson() => {};
}

class OrderStatus {
  OrderStatus([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory OrderStatus.fromJson(Map<String, dynamic> json) => OrderStatus();
  Map<String, dynamic> toJson() => {};
}

class EditProfile {
  EditProfile([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class UploadType {
  UploadType([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory UploadType.fromJson(Map<String, dynamic> json) => UploadType();
  Map<String, dynamic> toJson() => {};
}
...
class ExtrasType {
  ExtrasType([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory ExtrasType.fromJson(Map<String, dynamic> json) => ExtrasType();
  Map<String, dynamic> toJson() => {};
}
...
class OrderDetail {
  OrderDetail([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class LocationData {
  LocationData([var a, var b, var c, var d, var e, var f, var g, var h]);
  factory LocationData.fromJson(Map<String, dynamic> json) => LocationData();
  Map<String, dynamic> toJson() => {};
}

class Data {
  Data([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class ShopSection {
  ShopSection([var a, var b, var c, var d, var e, var f, var g, var h]);
...
class DisableDates {
  DisableDates([var a, var b, var c, var d, var e, var f, var g, var h]);
