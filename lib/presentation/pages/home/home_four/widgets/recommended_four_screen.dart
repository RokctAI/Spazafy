...
class RecommendedFourPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RecommendedFourPage> createState() => _RecommendedPageState();
}

class _RecommendedPageState extends ConsumerState<RecommendedFourPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final shouldUseBgImg = widget.bgImg ?? AppConstants.bgImg;
    return Scaffold(
      body: Column(
        children: [
          CommonAppBar(
